...
def main():
    try:
        ...
        # Filter by mis-match
        info("Filter by the 1-3 bp mis-match number...")
        ...
        # Insertion
        info( "`1-bp ins frequency` > " + str(oneins_freq_3q) + " and `MH del frequency` <= " + str(mmej_freq_3q) + " and  `MHless del frequency` <= " + str(nhej_freq_3q) )
        oneins_pddf = complete_info_pddf.query( "`1-bp ins frequency` > " + str(oneins_freq_3q) + " and `MH del frequency` <= " + str(mmej_freq_3q) + " and  `MHless del frequency` <= " + str(nhej_freq_3q) )
        info( str(len(oneins_pddf)) + " / " + str(len(complete_info_pddf)) + " targets represent a donominat 1 bp insertion" )
        ...
        # MMEJ
        info( "`1-bp ins frequency` <= " + str(oneins_freq_3q) + " and `MH del frequency` > " + str(mmej_freq_3q) + " and  `MHless del frequency` <= " + str(nhej_freq_3q) )
        mmej_pddf = complete_info_pddf.query( "`1-bp ins frequency` <= " + str(oneins_freq_3q) + " and `MH del frequency` > " + str(mmej_freq_3q) + " and  `MHless del frequency` <= " + str(nhej_freq_3q) )
        info( str(len(mmej_pddf)) + " / " + str(len(complete_info_pddf)) + " targets" )
        # mmej_framein_freq_3q = np.quantile( mmej_pddf.loc[ :, "Frame +0 frequency"], 0.75 )
        # mmej_framep1_freq_3q = np.quantile( mmej_pddf.loc[ :, "Frame +1 frequency"], 0.75 )
        # mmej_framep2_freq_3q = np.quantile( mmej_pddf.loc[ :, "Frame +2 frequency"], 0.75 )
        # info( "The third quartile (Q3) of 'Frame +0 frequency' is " + str( mmej_framein_freq_3q ) )
        # info( "The third quartile (Q3) of 'Frame +1 frequency' is " + str( mmej_framep1_freq_3q ) )
        # info( "The third quartile (Q3) of 'Frame +2 frequency' is " + str( mmej_framep2_freq_3q ) )
        # info( "Classify by the Q3s of dominant MMEJ data set...")
        
        # MMEJ frame-in
        info( "`Frame +0 frequency` > " + str(mmej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(mmej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(mmej_framep2_freq_3q) )
        mmej_framein_pddf = mmej_pddf.query( "`Frame +0 frequency` > " + str(mmej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(mmej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(mmej_framep2_freq_3q) )
        info( str(len(mmej_framein_pddf)) + " / " + str(len(mmej_pddf)) + " targets represent a dominant MMEJ-assisted frame-in" )

        # MMEJ frameshift +1
        info( "`Frame +0 frequency` <= " + str(mmej_framein_freq_3q) + " and `Frame +1 frequency` > " + str(mmej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(mmej_framep2_freq_3q) )
        mmej_framep1_pddf = mmej_pddf.query( "`Frame +0 frequency` <= " + str(mmej_framein_freq_3q) + " and `Frame +1 frequency` > " + str(mmej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(mmej_framep2_freq_3q) )
        info( str(len(mmej_framep1_pddf)) + " / " + str(len(mmej_pddf)) + " targets represent a dominant MMEJ-assisted frameshift (+1)" )

        # MMEJ frameshift +2
        info( "`Frame +0 frequency` <= " + str(mmej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(mmej_framep1_freq_3q) + " and  `Frame +2 frequency` > " + str(mmej_framep2_freq_3q) )
        mmej_framep2_pddf = mmej_pddf.query( "`Frame +0 frequency` <= " + str(mmej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(mmej_framep1_freq_3q) + " and  `Frame +2 frequency` > " + str(mmej_framep2_freq_3q) )
        info( str(len(mmej_framep2_pddf)) + " / " + str(len(mmej_pddf)) + " targets represent a dominant MMEJ-assisted frameshift (+2)" )

        # NHEJ
        info( "`1-bp ins frequency` <= " + str(oneins_freq_3q) + " and `MH del frequency` <= " + str(mmej_freq_3q) + " and  `MHless del frequency` > " + str(nhej_freq_3q) )
        nhej_pddf = complete_info_pddf.query( "`1-bp ins frequency` <= " + str(oneins_freq_3q) + " and `MH del frequency` <= " + str(mmej_freq_3q) + " and  `MHless del frequency` > " + str(nhej_freq_3q) )
        info( str(len(nhej_pddf)) + " / " + str(len(complete_info_pddf)) + " targets" )
        # nhej_framein_freq_3q = np.quantile( nhej_pddf.loc[ :, "Frame +0 frequency"], 0.75 )
        # nhej_framep1_freq_3q = np.quantile( nhej_pddf.loc[ :, "Frame +1 frequency"], 0.75 )
        # nhej_framep2_freq_3q = np.quantile( nhej_pddf.loc[ :, "Frame +2 frequency"], 0.75 )
        # info( "The third quartile (Q3) of 'Frame +0 frequency' is " + str( nhej_framein_freq_3q ) )
        # info( "The third quartile (Q3) of 'Frame +1 frequency' is " + str( nhej_framep1_freq_3q ) )
        # info( "The third quartile (Q3) of 'Frame +2 frequency' is " + str( nhej_framep2_freq_3q ) )
        # info( "Classify by the Q3s of dominant NHEJ data set...")
        
        # nhej frame-in
        info( "`Frame +0 frequency` > " + str(nhej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(nhej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(nhej_framep2_freq_3q) )
        nhej_framein_pddf = nhej_pddf.query( "`Frame +0 frequency` > " + str(nhej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(nhej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(nhej_framep2_freq_3q) )
        info( str(len(nhej_framein_pddf)) + " / " + str(len(nhej_pddf)) + " targets represent a dominant NHEJ-assisted frame-in" )

        # nhej frameshift +1
        info( "`Frame +0 frequency` <= " + str(nhej_framein_freq_3q) + " and `Frame +1 frequency` > " + str(nhej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(nhej_framep2_freq_3q) )
        nhej_framep1_pddf = nhej_pddf.query( "`Frame +0 frequency` <= " + str(nhej_framein_freq_3q) + " and `Frame +1 frequency` > " + str(nhej_framep1_freq_3q) + " and  `Frame +2 frequency` <= " + str(nhej_framep2_freq_3q) )
        info( str(len(nhej_framep1_pddf)) + " / " + str(len(nhej_pddf)) + " targets represent a dominant NHEJ-assisted frameshift (+1)" )

        # nhej frameshift +2
        info( "`Frame +0 frequency` <= " + str(nhej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(nhej_framep1_freq_3q) + " and  `Frame +2 frequency` > " + str(nhej_framep2_freq_3q) )
        nhej_framep2_pddf = nhej_pddf.query( "`Frame +0 frequency` <= " + str(nhej_framein_freq_3q) + " and `Frame +1 frequency` <= " + str(nhej_framep1_freq_3q) + " and  `Frame +2 frequency` > " + str(nhej_framep2_freq_3q) )
        ...
        # MMEJ / frame-in
        mmej_framein_pddf.insert( len(mmej_framein_pddf.columns) , "frame+0/MHlessdel", mmej_framein_pddf.loc[ :, "Frame +0 frequency" ] / mmej_framein_pddf.loc[ :, "MHless del frequency" ] )
        sorted_mmej_framein_hek293_pddf = mmej_framein_pddf.sort_values("frame+0/MHlessdel", ascending=False)
        
        # MMEJ / frameshift +1
        mmej_framep1_pddf.insert( len(mmej_framep1_pddf.columns) , "frame+1/MHlessdel", mmej_framep1_pddf.loc[ :, "Frame +1 frequency" ] / mmej_framep1_pddf.loc[ :, "MHless del frequency" ] )
        sorted_mmej_framep1_hek293_pddf = mmej_framep1_pddf.sort_values("frame+1/MHlessdel", ascending=False)
        
        # MMEJ / frameshift +2
        mmej_framep2_pddf.insert( len(mmej_framep2_pddf.columns) , "frame+2/MHlessdel", mmej_framep2_pddf.loc[ :, "Frame +2 frequency" ] / mmej_framep2_pddf.loc[ :, "MHless del frequency" ] )
        sorted_mmej_framep2_hek293_pddf = mmej_framep2_pddf.sort_values("frame+2/MHlessdel", ascending=False)
        
        # NHEJ / frame-in
        nhej_framein_pddf.insert( len(nhej_framein_pddf.columns) , "frame+0/MHdel", nhej_framein_pddf.loc[ :, "Frame +0 frequency" ] / nhej_framein_pddf.loc[ :, "MH del frequency" ] )
        sorted_nhej_framein_hek293_pddf = nhej_framein_pddf.sort_values("frame+0/MHdel", ascending=False)
        
        # NHEJ / frameshift +1
        nhej_framep1_pddf.insert( len(nhej_framep1_pddf.columns) , "frame+1/MHdel", nhej_framep1_pddf.loc[ :, "Frame +1 frequency" ] / nhej_framep1_pddf.loc[ :, "MH del frequency" ] )
        sorted_nhej_framep1_hek293_pddf = nhej_framep1_pddf.sort_values("frame+1/MHdel", ascending=False)
        
        # NHEJ / frameshift +2
        nhej_framep2_pddf.insert( len(nhej_framep2_pddf.columns) , "frame+2/MHdel", nhej_framep2_pddf.loc[ :, "Frame +2 frequency" ] / nhej_framep2_pddf.loc[ :, "MH del frequency" ] )
        sorted_nhej_framep2_hek293_pddf = nhej_framep2_pddf.sort_values("frame+2/MHdel", ascending=False)
        ...
        evaluated_nhej_framep1_hek293_pddf = pd.concat( [ sorted_nhej_framep1_hek293_pddf.head( 10 ), sorted_nhej_framep1_hek293_pddf.head( 10 ).apply( ProfileMutAcrossCellline, axis=1 ) ], axis=1 )
